...
public class EDIReaderProcessorTest {
    private static final Logger log = Logger.getLogger(EDIReaderProcessorTest.class.getName());

    private TestRunner testRunner;

    @Before
    public void init() {
        testRunner = TestRunners.newTestRunner(new EDIReaderProcessor());
    ...
    public void testOnTrigger() throws IOException {
        ...
        List<MockFlowFile> results = testRunner.getFlowFilesForRelationship(EDIReaderProcessor.REL_SUCCESS);
        ...
        System.out.println(IOUtils.toString(testRunner.getContentAsByteArray(result)).toString());
    }
